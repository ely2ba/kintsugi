...
Status: repository transition complete; local M0/M1 implementation underway.
...
probe clocks, retention and coverage. M1 launch is held while the author defines
the registered noise-bound construction; no claim threshold is guessed.
